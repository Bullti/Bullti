...
/**
 * <p>spring boot 3.x.x 버전에서 사용할떄</p>
 * 
 * <p> implementation 'io.awspring.cloud:spring-cloud-aws-starter-s3:3.1.0'</p>
 *
 * <p> ##############################################</p>
 * <p> application.properties 파일에 넣어야할 내용 </p>
 * <p> ##############################################</p>
 * <p> spring.cloud.aws.region.static=ap-northeast-2 </p>
 * <p> spring.cloud.aws.credentials.access-key=yourAccessKey</p>
 * <p> spring.cloud.aws.credentials.secret-key=yourSecretKey</p>
 * <p> ##############################################</p>
 * <p> cloud.aws.s3.bucket=springboot.green.bucket</p>
 * <p> cloud.aws.s3.upload-temp=goods/upload/temp/</p>
 * <p> cloud.aws.s3.upload-src=goods/upload/src/</p>
 * 
 */
@Slf4j
